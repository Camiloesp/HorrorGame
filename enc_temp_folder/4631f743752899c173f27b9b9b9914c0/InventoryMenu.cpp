...
bool UInventoryMenu::Initialize()
{
	...
	// Hide item info and description as we start the game
...
void UInventoryMenu::ShowItemInfo(FItemData ItemData)
{
	ItemNameText = FText::FromName(ItemData.ItemName);
...
void UInventoryMenu::HideItemInfo()
{
	ItemInfoVerticalBox->SetVisibility(ESlateVisibility::Hidden);
}
